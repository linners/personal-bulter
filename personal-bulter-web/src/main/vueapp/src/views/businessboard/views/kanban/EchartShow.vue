        ...
        return {
          ...
          tooltip: {
            ...
            formatter: (params, ticket, callback) => {
              ...
              params.forEach((obj, index, array) => {
                ...
                showContent = showContent + '<div style="padding: 5px 0px;color:#495060">' + marker + '<span>' + seriesName + '</span>&nbsp;&nbsp;<span style="float: right; margin-left: 30px">' + value + '</span></div>'
              })
              return '<p>'+name+'</p>'+showContent;
            }
          },
          legend: {
            type: 'scroll',
          ...
          xAxis: {
            ...
            axisLabel: {
              ...
              // interval:0,
              // rotate: option.xAxis.data.length<10?0:40
            },
            splitLine: {
              show: false,
              lineStyle: {
